    ...
    return (
        <>
            <div className="container mx-auto py-12 relative px-4">
                <img src={SubscribeIcon} className='absolute top-4 left-0 md:left-28 z-10' />
                ...
                <div className="w-full bg-purple-50 relative rounded-3xl rounded-tl-5xl overflow-hidden relative md:rounded-tl-[10rem]">
                    ...
                    <div className="w-full md:max-w-3xl mx-auto py-12 px-4 flex flex-col justify-center items-center">
                        <p className="text-xl md:text-3xl leading-tight text-slate-500 font-semibold text-center leading-relaxed py-8">
